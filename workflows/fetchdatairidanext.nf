...
workflow FETCHDATAIRIDANEXT {
    ...
    meta_accessions = input.map {meta ->
        if (meta.sample.size() != 1 || meta.accession.size() != 1) {
            throw new Exception("Either meta.sample or meta.accession do not have size of 1: ${meta}")
        }
